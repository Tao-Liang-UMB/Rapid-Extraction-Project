...
features.raw <- AnalyzeSpectra("New method v2 Correlation 20min 001 Caroff", snr = 5)  # change to your path
...
tiff("R figures/correlation figures SNR5 sig001/New Method 20min 001 vs Caroff Pearson.tiff",
...
diagdata
write.csv(diagdata, "R output files/New method v2 20min 001 Pearson vs Caroff diagdata SNR5 sig001.csv") #change to your path

# needs to be flipped around to match heatmap
simwrite <- as.data.frame(sim[nrow(sim):1, ])  # dfwrite is a variable name
write.csv(simwrite, "R output files/New method v2 20min 001 Pearson vs Caroff SNR5 sig001.csv")  #change to your path
