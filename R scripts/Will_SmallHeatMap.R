...
library(ggplot2)
library(scales)
source("R/AnalyzeSpectra.R")   # change to your path
set.seed(1234)

# Imports spectra, normalizes and performs peak picking. Check 
# <AnalyzeSpectra.R> for details

features <- AnalyzeSpectra("data/small", snr = 8)  # change your path
...
write.csv(dfwrite, "results/smallHeatMap.csv")  #change to your path
